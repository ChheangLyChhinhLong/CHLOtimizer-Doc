...
!!! note 
    This tweak was added in 2.14.0, CHLOtimizer 2.14.0+ is required.
  
## Details

- Disables Windows telemetry by modifying registry keys to prevent data collection and reporting to ~~Microsoft~~ Microslop. This tweak was previously in chloptimizer but was removed issues with the tweak not applying correctly. It has been re-added.
