# Apps Page Documentation (app.md)
...
CHLOtimizer supports two package managers:
...
* Select apps by clicking on them or using the checkbox
* Click **Install Selected** to install
* Click **Uninstall Selected** to remove apps
* The Install/Uninstall status is displayed in the titlebar.
...
After editing, submit a pull request on [GitHub via the CHLOtimizer Repository](https://github.com/ChheangLyChhinhLong/CHLOtimizer-Doc).
