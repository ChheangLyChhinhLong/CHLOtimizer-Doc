...
${
  tweak.addedversion 
  ? `!!! note 
    This tweak was added in ${tweak.addedversion}, CHLOtimizer ${tweak.addedversion}+ is required.
  ` 
  : ""
}
${deepDesc ? `## Details\n\n${deepDesc}` : ""}
...
# All CHLOtimizer Tweaks
A collection of tweaks to customize and enhance your Windows experience using CHLOtimizer.
